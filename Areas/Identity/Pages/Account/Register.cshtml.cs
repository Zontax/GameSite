 ...
 ErrorMessageResourceName = "RequiredField")]
    ...
    public async Task<IActionResult> OnPostAsync(string returnUrl = null)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            user.RegistrationDate = DateTime.Now; // Дата реєстраціїї
            user.Name = Input.Name.Trim(); //! Своє поле
...
#pragma warning disable IDE0037 // Использовать имя выводимого элемента
                ...
                await _emailSender.SendEmailAsync(Input.Email, "Підтвердіть свою електронну пошту",
                    $"Будь ласка, підтвердіть вашу електронну пошту <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>натиснувши тут</a>.");
